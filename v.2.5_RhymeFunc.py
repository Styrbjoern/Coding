...
st.caption("When you pick a type of poem from the box, NPG creates a unique poem just for you. Your poem might not make sense (at all!), but it can always be read out loud in the rhythm of the type of poem you chose. NPG doesn't know a whole lot of different words yet, but it'll always do its best to come up with something that rhymes in the right places!")
